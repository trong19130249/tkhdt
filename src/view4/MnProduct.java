...
public class MnProduct extends JPanel {
...
//	private Border lineBorder = new LineBorder(new Color(0, 144, 255), 2);
	...
	public MnProduct(String[] columnNames, Object[][] rowData) {
		this.columnNames = columnNames;
		this.rowData = rowData;

		// bắt đầu set property cho button
                btnAdd.setIcon(new ImageIcon(getClass().getResource("/SwingIcon/"+ "Button-Add-icon.png")));
		btnAdd.setBackground(new Color(255, 255, 255));
                btnAdd.setOpaque(false);

//		btnAdd.setBorder(lineBorder);

		btnFix.setIcon(new ImageIcon(getClass().getResource("/SwingIcon/"+ "SuaIcon.png")));
		btnFix.setBackground(null);
//		btnFix.setBorder(lineBorder);

		btnDelete.setIcon(new ImageIcon(getClass().getResource("/SwingIcon/"+ "XoaIcon.png")));
                
		btnDelete.setBackground(null);
//		btnDelete.setBorder(lineBorder);

		btFilter.setIcon(new ImageIcon(getClass().getResource("/SwingIcon/FilterIcon.png")));
...
//		panelBtns1.setBackground(Color.WHITE);
		...
		panelBtns3.add(new JLabel("  Danh mục hàng hóa"), BorderLayout.NORTH);
