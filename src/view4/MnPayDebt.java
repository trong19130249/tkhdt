...
public class MnPayDebt extends JPanel {
	...
	private JLabel lbFilterTitle1 = new JLabel("Theo tên nhà cung cấp");
	private JTextField jtfFilter = new JTextField();
	private JButton btFilter = new JButton(" Lọc ");
	private JButton btCancel = new JButton(" Hủy ");


	private JLabel lbFilterTitle2 = new JLabel("Theo ngày trả tiền");
	...
	private float[] columnWidthPercentage = { 0.03f, 0.34f, 0.08f, 0.08f, 0.36f };
	double rateWidthTable = 1.0;

	public MnPayDebt(String[] columnNames, Object[][] rowData) {
		...
		panelBtns3.add(new JLabel("  Thao tác trả nợ"), BorderLayout.NORTH);
