...
public class FixSupplier extends JFrame {
	private JLabel lbCode = new JLabel("  Mã NCC: ");
	...
	private JLabel lbDebt = new JLabel("  Nợ NCC: ");
	...
	public static void main(String[] args) {
		FixSupplier frame = new FixSupplier();
