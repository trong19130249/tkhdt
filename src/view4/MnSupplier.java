...
public class MnSupplier extends JPanel {
	...
	private String[] filterTitle = { "Theo mã nhà cung cấp", "Theo tên nhà cung cấp", "Theo số điện thoại" };
	...
	private float[] columnWidthPercentage = { 0.01f, 0.1f, 0.2f, 0.14f, 0.18f, 0.12f, 0.14f };

	public MnSupplier(String[] columnNames, Object[][] rowData) {
		...
		panelBtns3.add(new JLabel("  Danh mục nhà cung cấp"), BorderLayout.NORTH);
