...
public class DetailAnOrder extends JFrame {
	...
	public DetailAnOrder(String[] columnNames, Object[][] rowData) {
		...
		panelBtns3.add(new JLabel("  Danh sách hàng hóa"), BorderLayout.NORTH);
		...
		setTitle("Chi tiết một đơn hàng");
		setSize(880, 580);
