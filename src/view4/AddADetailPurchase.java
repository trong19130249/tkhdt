...
public class AddADetailPurchase extends JFrame {
	...
	public AddADetailPurchase() {
		...
		setTitle("Thêm hàng hóa vào chi tiết hàng hóa để nhập");
		setSize(500, 300);
	...
	public static void main(String[] args) {
		AddADetailPurchase frame = new AddADetailPurchase();
		frame.setTitle("Thêm hàng hóa vào chi tiết hàng hóa để nhập");
