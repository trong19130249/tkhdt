...
public class MnPurchases extends JPanel {
	...
	private float[] columnWidthPercentage = { 0.01f, 0.06f, 0.08f, 0.36f, 0.12f, 0.12f };
	double rateWidthTable = 1.0;

	public MnPurchases(String[] columnNames, Object[][] rowData) {
